...
import com.example.administrator.huorongdai.adapter.DepthPageTransformer;
...
public class GuideActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        XStatusBar.setTransparentForImageView(this,mIn_vp);
        initView();

    }

    private void initView() {
        XPreferencesUtils.put("FIRST",false);
