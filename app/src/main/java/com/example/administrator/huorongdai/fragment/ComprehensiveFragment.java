 ...
 * 综合
 */
public class ComprehensiveFragment extends LazyLoadFragment {
    private static ComprehensiveFragment fragment;

    public ComprehensiveFragment(){

    }
    public static ComprehensiveFragment getInstance() {
        if (fragment == null) {
            synchronized (ComprehensiveFragment.class) {
                if (fragment == null) {
                    fragment = new ComprehensiveFragment();
                }
            }
        }
        return fragment;
    ...
    protected void initViews() {
        ...
        refreshLayout=findViewById(R.id.srl_comprehensive_fragment);
        refreshLayout.setColorScheme(R.color.word_red);
        recyclerView=findViewById(R.id.rl_comprehensive_fragment);
    ...
    private void requestData() {
        ...
        params.put("ivstCategory","3");//5是全部，小微是2，综合是3，新手是1
