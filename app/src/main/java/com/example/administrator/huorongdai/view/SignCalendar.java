...
public class SignCalendar extends ViewFlipper implements GestureDetector.OnGestureListener {
    public static final int COLOR_BG_WEEK_TITLE = Color.parseColor("#057dff"); // 星期标题背景颜色
    public static final int COLOR_TX_THIS_MONTH_DAY = Color.parseColor("#5d5d5d"); // 当前月日历数字颜色
    public static final int COLOR_TX_OTHER_MONTH_DAY = Color.parseColor("#bfbfbf"); // 其他月日历数字颜色
...
//        push_right_out = AnimationUtils.loadAnimation(getContext(), R.anim.push_right_out);
    ...
    private void drawFrame(LinearLayout oneCalendar) {
        ...
        title.setBackgroundResource(R.drawable.dialog_sgin_title_bule_selector);
        ...
        tb = res.getDimension(R.dimen.dp30);
...
//                        if(view!=null){
//                            view.setBackgroundResource(R.drawable.dotted_line_left_top);
//                        }
                        // 设置标记
                        setMarker(group, 0, k);
                    }
...
//                        if(4==i){
//                            if(6==j){
//                                view.setBackgroundResource(R.drawable.dotted_line_last);
//                            }else {
//                                view.setBackgroundResource(R.drawable.dotted_line_left_top_bottom);
//                            }
//                        }else if(6==j && 4!=i){
//                            view.setBackgroundResource(R.drawable.dotted_line_left_top_right);
//                        }else {
//                            view.setBackgroundResource(R.drawable.dotted_line_left_top);
//                        }
...
//                        }
    ...
    private void setMarker(RelativeLayout group, int i, int j,TextView view) {
        ...
        if (marksMap.get(dates[i][j]) != null) {
            view.setTextColor(Color.parseColor("#e24d4f"));
        } else {
            view.setTextColor(COLOR_TX_THIS_MONTH_DAY);
        }
    }
    ...
    private void setMarker(RelativeLayout group, int i, int j) {
        ...
        if (marksMap.get(dates[i][j]) != null) {
            if (childCount < 2) {
                ...
                //标记图片 可自定义
                markView.setBackgroundResource(R.color.green);
