...
import com.example.administrator.huorongdai.view.banner.listener.OnBannerClickListener;
import com.example.administrator.huorongdai.view.banner.listener.OnBannerListener;
import com.example.administrator.huorongdai.view.banner.loader.ImageLoaderInterface;
import com.example.administrator.huorongdai.view.banner.view.BannerViewPager;
...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorWidth = ScreenAdapterTools.getInstance().loadCustomAttrValue(mIndicatorWidth);
        mIndicatorHeight = ScreenAdapterTools.getInstance().loadCustomAttrValue(mIndicatorHeight);
        mIndicatorMargin = ScreenAdapterTools.getInstance().loadCustomAttrValue(mIndicatorMargin);
    }
