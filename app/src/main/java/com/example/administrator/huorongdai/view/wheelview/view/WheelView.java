package com.example.administrator.huorongdai.view.wheelview.view;
...
import com.example.administrator.huorongdai.view.wheelview.adapter.WheelAdapter;
import com.example.administrator.huorongdai.view.wheelview.interfaces.IPickerViewData;
import com.example.administrator.huorongdai.view.wheelview.listener.LoopViewGestureListener;
import com.example.administrator.huorongdai.view.wheelview.listener.OnItemSelectedListener;
import com.example.administrator.huorongdai.view.wheelview.timer.InertiaTimerTask;
import com.example.administrator.huorongdai.view.wheelview.timer.MessageHandler;
import com.example.administrator.huorongdai.view.wheelview.timer.SmoothScrollTimerTask;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        if(!isInTouchMode()){
            textSize = ScreenAdapterTools.getInstance().loadCustomAttrValue(textSize);
        }
    }
