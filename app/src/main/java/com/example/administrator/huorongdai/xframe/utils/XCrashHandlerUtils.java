package com.example.administrator.huorongdai.xframe.utils;
...
import com.example.administrator.huorongdai.xframe.common.XActivityStack;
...
public class XCrashHandlerUtils implements Thread.UncaughtExceptionHandler {
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            String fileName = "crash-" + XDateUtils.getCurrentDate() + "-" + timestamp + ".txt";
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                String path = Environment.getExternalStorageDirectory().getPath() + "/MyAppCrash/";
