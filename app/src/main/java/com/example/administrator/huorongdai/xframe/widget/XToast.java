package com.example.administrator.huorongdai.xframe.widget;
...
public class XToast {
    ...
    public static Toast custom( @NonNull String message, Drawable icon,
        ...
        ScreenAdapterTools.getInstance().loadView(toastLayout);
        ...
        Drawable drawableFrame= XOutdatedUtils.getDrawable(R.drawable.xtoast_bg);
